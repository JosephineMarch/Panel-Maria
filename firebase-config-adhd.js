/*
================================================================================
|       PANEL MAR├ìA - CONFIGURACI├ôN DE FIREBASE (PLANTILLA DE EJEMPLO)
================================================================================
*/
...
// 1. Crea una COPIA de este archivo y ren├│mbrala a "firebase-config.js".
// 2. El archivo "firebase-config.js" est├í ignorado por Git para que no se suba.
...
try {
  ...
  // alert('Error al inicializar Firebase. Por favor, revisa la consola para m├ís detalles.');
}
